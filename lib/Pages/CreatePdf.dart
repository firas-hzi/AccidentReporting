...
class CreatePdf {
  ...
  Future<String> createPdfFile(Accident accident, List<Tire> tires) async {
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
                        Text(
                          'CCbyExpert',
                          style:
                              headerTextStyle.copyWith(fontSize: 22),
                          textScaleFactor: 1,
                        ),
                        PdfLogo()
                      ])),
                ...
                children: <TableRow>[
                  ...
                  TableRow(
                   ...
                   Container(
                          ...
                          child:    Align(
                        alignment: Alignment.center,
                        child: Text(tires[0].brand ?? '', style: pdfTextStyle),
                      ),),
                    Container(
                          height: 35,
                          child:   Align(
                  ...
                  TableRow(
                    children: <Widget>[
                     ...
                     Container(
                          ...
                          child:  Align(
                        alignment: Alignment.center,
                        child: Text(tires[1].brand ?? '', style: pdfTextStyle),
                      ),),
                      Container(
                          height: 35,
                          child: Align(
                  ...
                  TableRow(
                   ...
                   Container(
                    ...
                    Container(
                          ...
                          child:   Align(
                        alignment: Alignment.center,
                        child: Text(tires[2].brand ?? '', style: pdfTextStyle),
                      ),),
                     Container(
                          height: 35,
                          child:  Align(
                    ...
                    children: <Widget>[
                     Container(
                      ...
                      Container(
                          ...
                          child: Align(
                        alignment: Alignment.center,
                        child: Text(tires[3].brand ?? '', style: pdfTextStyle),
                      ),),
                     Container(
                          height: 35,
                          child:  Align(
